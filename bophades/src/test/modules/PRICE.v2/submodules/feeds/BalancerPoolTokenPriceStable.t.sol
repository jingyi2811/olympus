...
contract BalancerPoolTokenPriceStableTest is Test {
    ...
    address BALANCER_POOL = 0x3dd0843A028C86e0b760b1A76929d1C5Ef93a2dd;
    uint256 BALANCER_POOL_TOTAL_SUPPLY = 958624077083577011345827;
    uint8 BALANCER_POOL_DECIMALS = 18;

    uint256 INVARIANT = 992171333546814908493721;
    uint256 AMP_FACTOR = 50000;

    address B_80BAL_20WETH = 0x5c6Ee304399DBdB9C8Ef030aB642B10820DB8F56;
    address AURA_BAL = 0x616e8BfA43F920657B3497DBf40D6b1A02D4608d;

    uint8 B_80BAL_20WETH_DECIMALS = 18;
    uint8 AURA_BAL_DECIMALS = 18;
    ...
    function test_getTokenPriceFromStablePool_priceDecimalsFuzz() public {
        uint8 priceDecimals_ = 12;
    ...
    function test_getStablePoolTokenPrice_priceDecimalsMaximum() public {
        uint8 priceDecimals = MAX_DECIMALS;
        setUpStablePoolTokenPrice();

        uint poolDecimals_ = 8;
        uint priceDecimals_ = 8;
